...
namespace TempFuncs {
  ...
  template<class T,class Y,class CompType> struct PairComp {
  ...
  template <class T1,class T2,typename Comp=std::less<T1> > struct PairSortBy1st {
    Comp comp;
  ...
  template <class T1,class T2,typename Comp=std::less<T2> > struct PairSortBy2nd {
    Comp comp;
   ...
   template <class T1,class T2> struct PairEq1st {
   ...
   template <class T1,class T2> struct PairEq2nd {
     T2 val;
